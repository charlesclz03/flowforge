...
export default function SessionSummaryModal({
  ...
  useEffect(() => {
    if (!shouldReduceMotion && data?.newBadges && data.newBadges.length > 0) {
      setTimeout(() => {
        confetti({
          particleCount: 150,
          spread: 70,
  ...
  }, [data?.newBadges, shouldReduceMotion])
  ...
  return (
    <Modal isOpen={!!data} onClose={onClose} dialogLabel="Session results">
        ...
        <div className="space-y-4">
          ...
          <div className="text-center space-y-2">
            <motion.div
              ...
              transition={shouldReduceMotion ? undefined : { type: 'spring' }}
                ...
                <div className="h-3 bg-black/40 rounded-full overflow-hidden relative">
                  ...
                  {step >= 1 && (
                    <motion.div
                      ...
                      className="absolute inset-y-0 left-[0%] w-full bg-white/50 motion-safe:animate-pulse"
                      style={{
            ...
            {step >= 2 && data.newBadges && data.newBadges.length > 0 && (
              ...
              >
                <div className="flex flex-col items-center gap-2">
                  <Sparkles
                    className="text-yellow-300 motion-safe:animate-spin-slow"
                    size={24}
                  />
          ...
          <div className="flex justify-center pt-2">
            <Button onClick={onClose} className="w-full max-w-xs font-bold">
              Continue
            </Button>
          </div>
        </div>
