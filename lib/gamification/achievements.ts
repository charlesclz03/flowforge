...
export class AchievementSystem {
  static async checkAndUnlock(userId: string, context: { 
    ...
    const checks = [
      ...
      { 
        ...
        condition: context.type === 'SESSION_COMPLETE' && (new Date().getDay() === 0 || new Date().getDay() === 6) 
      }
    ]
