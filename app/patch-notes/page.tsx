        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-12 relative before:absolute before:left-4 md:before:left-1/2 before:top-0 before:bottom-0 before:w-px before:bg-gradient-to-b before:from-purple-500 before:via-zinc-800 before:to-transparent before:-translate-x-1/2 before:opacity-30">
            {PATCH_NOTES.map((note, index) => (
              ...
              >
                {/* Timeline Node */}
                <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-zinc-950 border-2 border-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.5)] mt-6" />
                ...
                <div className="md:grid md:grid-cols-2 md:gap-12 items-start">
                  ...
                  >
                    <div
                      className={`bg-zinc-900/40 border border-zinc-800/50 rounded-xl p-5 hover:border-purple-500/30 transition-colors ${index % 2 !== 0 ? 'md:text-left' : ''}`}
                    >
