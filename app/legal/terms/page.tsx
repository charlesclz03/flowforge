          ...
          <div className="mt-8 space-y-8 text-text-secondary prose prose-invert max-w-none text-sm leading-relaxed">
            <section>
              ...
              <p>
                ...
                (collectively, the &quot;Service&quot;), you agree to be bound
                by these Terms of Service (&quot;Terms&quot;). If you do not
                agree to these Terms, including the mandatory arbitration
                provision and class action waiver in Section 13, you may not
            ...
            <section>
              ...
              <p>
                You must be at least 13 years of age to access or use the
                Service. If you are under 18 years of age (or the age of legal
                majority where you live), you may only use the Service with the
                permission of a parent or legal guardian who agrees to be bound
                by these Terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                using a valid Google authentication credential. You are
            ...
            <section>
              ...
              <p>
                ...
                FreeStyla claims no ownership rights over the creative content
              ...
              <p className="mt-2">
                ...
                (e.g., saving your tracks to the cloud or displaying them on
                your profile).
              </p>
              ...
              <ul className="list-disc pl-5 space-y-2 mt-2">
                ...
                <li>
                  ...
                  commercial advertisements (TV, Radio, Online Ads) or
                  third-party commercial projects without a separate written
                  license from FreeStyla.
                </li>
              </ul>
              ...
              <p>
                &quot;FREESTYLA&quot; is a registered label and trademark
                utilized by the Company. Unauthorized use of the FreeStyla
                brand, logo, or associated label identity without express
              ...
              <p>
                To protect the integrity of our System Beats and the rights of
                our users, we utilize <strong>Identifyy</strong> (and other
                content ID systems) to monitor content usage across digital
                platforms.
              </p>
              <p className="mt-2">
                ...
                composition remains the exclusive property of
                FreeStyla/FlowForge.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 mt-2">
                ...
                <li>
                  ...
                  subscription at any time through your Profile Settings.
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 mt-2">
                ...
                <li>
                  ...
                  (e.g., rapping over copyrighted beats you do not have rights
                  to) or violate the <strong>Beat Usage License</strong>{' '}
                  (Section 4.3).
                </li>
                <li>
            ...
            <section>
              ...
              <p className="mt-4">
                ...
                INCLUDING LOSS OF PROFITS, DATA, OR USE, WHETHER INCURRED
            ...
            <section>
              ...
              <p>
                ...
                informally. In the unlikely event that FreeStyla has not been
                able to resolve a dispute it has with you after sixty (60) days,
